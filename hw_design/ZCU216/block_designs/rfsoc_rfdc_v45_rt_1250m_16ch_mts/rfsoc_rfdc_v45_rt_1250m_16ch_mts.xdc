...
create_clock -period 3.333 -name PL_CLK_clk -waveform {0.000 1.666} [get_ports {PL_CLK_clk_p}]

#Input Delay for PL_SYSREF to ensure MTS requirements via PG269
 set_input_delay -clock [get_clocks PL_CLK_clk] -min -add_delay 2.9 [get_ports PL_SYSREF_clk_p];
 set_input_delay -clock [get_clocks PL_CLK_clk] -max -add_delay 3.1 [get_ports PL_SYSREF_clk_p];

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets rfsoc_rfdc_v45_rt_1250m_16ch_mts_i/MTS_block/IBUFDS_PL_CLK/U0/USE_IBUFDS.GEN_IBUFDS[0].IBUFDS_I/O]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets rfsoc_rfdc_v45_rt_1250m_16ch_mts_i/MTS_block/BUFG_PL_CLK/U0/BUFG_O[0]]
